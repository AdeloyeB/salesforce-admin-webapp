          ...
          <div class="col-lg-7">
            <div class="row mb-3">
              ...
              <div class="col-md-11 col-10">
                ...
                <p class="grey-text">
                  Users can manage development projects. Key information is
                  provided, approval systems etc. This system is unique for a
                  specifc team in the business. Let us know if you have an
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-11 col-10">
                ...
                <p class="grey-text">
                  Budget Movements need to be approved by the business in order
                  for it to go through. This allows the whole team to understand
                  where the project is currently at and what is going to happen
                  in the future.
                </p>
              </div>
            </div>
            ...
            <div class="row mb-lg-0 mb-5">
              ...
              <div class="col-md-11 col-10">
                ...
                <p class="grey-text mb-0">
                  Development Project Portal has been created in order to allow
                  external contractors to access projects easily and view data
                  and information about the project. A salesforce license isn't
                  even needed to view these projects
                </p>
              </div>
            </div>
          </div>
